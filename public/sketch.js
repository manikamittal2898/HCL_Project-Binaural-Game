...
function preload() {
 ...
 img = loadImage('1.gif'); // load media and other data
...
function preload2() {
	console.log("I am inside preload");
 img = loadImage('canvas3.png'); // load media and other data
 
}
function setup() {
    //console.log(model);
	// let canvas = createCanvas(480, 640);
	//console.log("I am inside canvas");
	let canvas = createCanvas(1200, 700); //700
